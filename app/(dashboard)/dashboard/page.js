...
export default function Dashboard() {
  //
  const [name, setName] = useState("SHYAM JEWELLERS");
  const [email, setEmail] = useState("");
  const [address, setAddress] = useState("PALI ROAD DIPKA , NEAR SOMWARI BAZAAR, KORBA CHHATTISGARH");
  const [phoneNumber, setPhoneNumber] = useState("8109655562,8770644986,8224886769");
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid gap-8">
              ...
              <article className="article">
                  ...
                  <input
                    ...
                    name="invoice-number"
                    id="invoice-number"
                    placeholder="Invoice Number as per Bill Book"
                    value={invoiceNumber}
            ...
            <div className="grid gap-8">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <article className="article">
                  <label htmlFor="client-email">Client Phone Number</label>
                  <input
                    type="email"
